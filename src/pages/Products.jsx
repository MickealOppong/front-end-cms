...
const Products = () => {
  ...
  return <section className={`mt-36 lg:mt-8 h-[300vh] px-8 max-w-[80vw] mx-auto `
  }>
    <div className={`flex flex-col gap-y-4 md:flex-row bg-white lg:gap-x-2 md:justify-between p-4 border-2 rounded w-11/12`}>
